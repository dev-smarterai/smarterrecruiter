...
// Utility function to parse salary with better error handling
...
export default function NewJobPage() {
  ...
  const createJob = useMutation(mutations.createJob)
  ...
  const handlePublishJob = async () => {
    ...
    try {
      ...
      // Format requirements and benefits from string to array
      ...
      const newJob = {
        ...
        featured: false,
        description: {
          intro: `Your Company is looking for a talented ${validationResult.data.title} to join our team.`,
        ...
        expiry: validationResult.data.deadline
          ...
          : new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toLocaleDateString("en-US", { day: "2-digit", month: "short", year: "numeric" }),
        level: validationResult.data.jobLevel || "Not specified",
        experience: validationResult.data.experienceLevel || "Not specified",
        education: "Not specified",
      }

      // Log the data being sent for debugging
      console.log("Creating job with validated data:", newJob)

      // Create new job using Convex
      ...
      if (error instanceof Error) {
        ...
        alert("There was an error creating the job. Please check all fields and try again.")
      }
    }
  }
        ...
        <AIContentBlock delay={0} blockType="header">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              {/* <h1 className="text-xl font-semibold text-gray-800">Interactive Job Creation</h1> */}
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <AIContentBlock delay={1} blockType="card">
              <div className="bg-white rounded-3xl shadow-sm overflow-hidden">
                <div className="">
                  <AskAdamCandidate 
                    initialInputValue="Help me create a professional job posting"
