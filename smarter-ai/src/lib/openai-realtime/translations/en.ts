export const en = {
    ...
    language: "English",
    // The languagePrompt has been intentionally removed to prevent fallbacks.
    // All AI interviews MUST use job-specific prompts defined in the AI meeting component.
}